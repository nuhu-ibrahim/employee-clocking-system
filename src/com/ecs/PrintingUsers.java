...
public class PrintingUsers extends JInternalFrame implements Printable {
	/***************************************************************************
	...
	private String URL = "jdbc:odbc:census";
	...
	public PrintingUsers(String query) {
		super("Printing Users", false, true, false, true);
		...
		try {
			...
			textArea.append("=============== Users' Information ===============\n\n");
			while (resultset.next()) {
				textArea.append("Surname: " + resultset.getString("Surname") + "\n" +
