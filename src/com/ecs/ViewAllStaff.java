...
public class ViewAllStaff extends javax.swing.JInternalFrame {
    ...
    private void createTable(){
        String sql="SELECT staff_id, fname, mname, lname, gender, mstatus, religion, dob from staff_pers_info";
        
        JTable table;
        TableColumn column = null;
        JScrollPane scrollPane;
        String meta[]={"Staff ID","Firstname", "Middlename", "Lastname","Gender","Marital Status", "Religion", "Date of Birth"};
    ...
    private void initComponents() {
        ...
        jLabel4.setText("VIEW ALL STAFF");
