...
public class ViewDuePayment extends javax.swing.JInternalFrame {

    /**
     * Creates new form PersonalDetails
     */
    public ViewDuePayment() {
    ...
    private void createTable(){
        ...
        String sql="SELECT staff_id, amount_in, amount_out, balance, description, date from staff_acct_trans where date between '"+fromDate+"' and '"+toDate+"' ORDER BY date DESC";
    ...
    private void initComponents() {
        ...
        jLabel5.setText("STAFFS PAYMENT INFORMATION");
    ...
    private void generateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_generateActionPerformed
        if(this.toDate.getDate()==null || this.fromDate.getDate()==null){
            ...
            try{
                ...
                String sql="select * from staff_acct_trans where date between ? and ?";
