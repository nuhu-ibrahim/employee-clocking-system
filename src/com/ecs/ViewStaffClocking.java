...
public class ViewStaffClocking extends javax.swing.JInternalFrame {

    public ViewStaffClocking() {
   ...
   scrollPane.setViewportView(table);
    ...
    private void initComponents() {
        ...
        jLabel5.setText("STAFF CLOCKING INFORMATION");
        ...
        if(this.toDate.getDate()==null || this.fromDate.getDate()==null || staffId.getText().equals("")){
            ...
            try{
                ...
                if(DBConnection.rs.next()){
                    String sql="select * from staff_sign_in where sign_in_time between ? and ? AND  staff_sign_in.staff_id = ? AND status = 'OUT'";
