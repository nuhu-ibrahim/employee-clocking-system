...
public class SignInVerifyBio extends javax.swing.JInternalFrame {
    ...
    public StaffSignIn main;
    private DPFPTemplate template;
    private DPFPFeatureSet features;
    
    public SignInVerifyBio(StaffSignIn main) {
        this.main = main;
        DBConnection.connect();
        initComponents();
        
        onLoad(this.main.getStaffId()+".fpt");
    ...
    private void validateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_validateActionPerformed
        ...
        if (features != null)
        {
            ...
            if (result.isVerified()){
                ...
                //After biometric has been confirmed
                try{
                    ...
                    String sql = "insert into staff_sign_in (staff_id, sign_in_time, sign_out_time, status, in_time, out_time) values (?,?,?,?,?,?)";
                    st = DBConnection.con.prepareStatement(sql);
                    st.setString(1, main.getStaffId());
                    ...
                    JOptionPane.showMessageDialog(this, "Staff signed in successfully", "Information", JOptionPane.INFORMATION_MESSAGE);
                    refresh();
                }catch(Exception ex){
                ...
                JOptionPane.showMessageDialog(this, "The fingerprint was NOT VERIFIED.","Information", JOptionPane.ERROR_MESSAGE);
            }
        }
